  ...
  useEffect(() => {
    const applyFilters = () => {
      ...
      const filteredSkips = allSkips.filter((skip) => {
        // Only check heavy waste for filtering out skips
        if (filters.heavyWasteAllowed && !skip.allows_heavy_waste) return false;

        // For road placement, include or exclude based on the filter
            ...
            <>
              ...
              <Portal wrapperId="filters-modal">
                ...
                >
                  ...
                  {/* Mobile features - Updated Toggle Design */}
                  <div className="mb-6">
                    <h3 className="text-sm font-medium text-gray-700 mb-3">
                      Placement Options
                    </h3>
                    <div className="bg-gray-50 p-3 rounded-md mb-4">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-12 items-center rounded-full mx-2 transition-colors ${
                            filters.roadAllowed ? "bg-green-600" : "bg-gray-300"
                          }`}
                        >
                          <span
                            className={`
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            {filters.heavyWasteAllowed
                              ? "Showing only skips that allow heavy waste"
                              : "Showing all skips, including those that don't allow heavy waste"}
                          </p>
                        </div>
                        <button
                          onClick={() =>
              ...
              >
                <div className="flex flex-col space-y-3">
                  ...
                  {/* Desktop Feature Filters - Updated Toggle Design */}
