...
export const RecycleIcon = ({ className }: { className: string }) => {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M21.82,15.42L19.32,19.75C18.83,20.61 17.92,21.06 17,21H15V23L12.5,18.5L15,14V16H17.82L15.6,12.15L19.93,9.65L21.73,12.77C22.25,13.54 22.32,14.57 21.82,15.42M9.21,3.06L14.51,7.02L11.67,9.33L6.56,5.5C5.56,4.8 5.2,3.5 5.81,2.45L6.25,1.65C6.98,0.45 8.59,0.11 9.71,0.97L10.57,1.58L8.43,3.15L9.21,3.06M14.21,12.18L11.91,8.94L14.75,6.63L16.95,10.36L19.39,8.75L12.47,4.62C11.36,3.91 9.9,4.1 9.05,5.09L4.16,11.39C3.45,12.38 3.56,13.65 4.4,14.53L10.5,20.04C11.42,20.89 12.79,20.89 13.7,20.04L15.73,18.08L14.21,12.18Z" />
    </svg>
  );
};
...
export const SortIcon = ({ className }: { className: string }) => {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M3 18h6v-2H3v2zM3 6v2h18V6H3zm0 7h12v-2H3v-2z" />
  </svg>
  );
};
